...
async function renderWeekdayReturns(res, date, endDate, route) {
    ...
    return res.render(`${route}/returnSummaryNYR`, {
        header: `NYR between Return Dates ${moment(date).format("DD/MM/YYYY")} and ${moment(endDate).format("DD/MM/YYYY")}`,
        date,
        endDate,
        nextDay,
        mmrcReturns,
...
async function renderWeekendReturns(res, date, endDate, allDates, route) {
