...
const route = "clearance/approve";

module.exports = {
    
    selectDate: async (req, res) => {
        const { date } = req.body;
        return res.redirect(`/clearance/approve/${date}`);
    },
    renderIndex: async (req, res) => {
        ...
        return res.render("clearance/approve/Index", {
    ...
    updateIndex: async (req, res) => {
        ...
        return res.redirect(
            `/clearance/approve/${date}/issueSummary/${date}/R2/after9`
        );
    },
